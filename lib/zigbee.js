...
const shepherdSettings = {
    ...
    coordinatorBackupPath: data.joinPath('coordinator_backup.json'),
    serialport: {
...
shepherdSettingsLog.network.networkKey = 'HIDDEN';
...
class Zigbee {
    ...
    async start(messageHandler, callback) {
        ...
        this.controller = new ZigbeeHerdsman.Controller(shepherdSettings);
