...
const NUMERIC_DISCOVERY_LOOKUP: {[s: string]: KeyValue} = {
    ...
    cpu_temperature: {device_class: "temperature", entity_category: "diagnostic", state_class: "measurement"},
    ...
    device_temperature: {device_class: "temperature", entity_category: "diagnostic", state_class: "measurement"},
    ...
    internalTemperature: {device_class: "temperature", entity_category: "diagnostic", state_class: "measurement"},
    linkquality: {enabled_by_default: false, entity_category: "diagnostic", icon: "mdi:signal", state_class: "measurement"},
    ...
    requested_brightness_level: {enabled_by_default: false, entity_category: "diagnostic", icon: "mdi:brightness-5"},
    requested_brightness_percent: {enabled_by_default: false, entity_category: "diagnostic", icon: "mdi:brightness-5"},
    ...
    water_consumed: {device_class: "water", state_class: "total_increasing"},
