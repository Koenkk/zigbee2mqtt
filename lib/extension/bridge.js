...
class Bridge extends Extension {
    ...
    async deviceChangeOptions(message) {
        return this.changeEntityOptions('device', message);
    }

    async groupChangeOptions(message) {
