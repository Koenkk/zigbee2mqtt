...
class DeviceBind {
    ...
    async onMQTTMessage(topic, message) {
        ...
        const source = await utils.getEndpointByEntityID(this.zigbee, sourceEntity.ID, topic.postfix);
        ...
        if (targetEntity.type === 'device') {
            target = await utils.getEndpointByEntityID(this.zigbee, targetEntity.ID, targetEntityIDPostfix.postfix);
