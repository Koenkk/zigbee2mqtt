...
const thermostat = (minTemp=7, maxTemp=30, temperatureStateProperty='occupied_heating_setpoint',
...
const mapping = {
    ...
    '3157100': [thermostat(10, 30, 'occupied_heating_setpoint', 1, ['off', 'heat', 'cool'],
    ...
    'RC-2000WH': [thermostat(10, 30, 'occupied_heating_setpoint', 1, ['off', 'auto', 'heat', 'cool'],
    ...
    'TS0601_thermostat': [
        ...
        thermostat(5, 30, 'current_heating_setpoint', 0.5, [], [], ['schedule', 'manual', 'away', 'boost', 'complex']),
    ],
