...
const cfg = {
    ...
    'sensor_device_temperature': {
        type: 'sensor',
        object_id: 'sensor_device_temperature',
        discovery_payload: {
            unit_of_measurement: '°C',
            device_class: 'temperature',
            value_template: '{{ value_json.sensor_device_temperature }}',
        },
    },
...
const mapping = {
    ...
    'HS2SW1A/HS2SW1A-N': [cfg.switch, cfg.sensor_temperature],
    ...
    'HS2SW3A/HS2SW3A-N': [
        ...
        switchEndpoint('center'), cfg.sensor_temperature,
    ],
...
class HomeAssistant extends Extension {
    ...
    discover(resolvedEntity, force=false) {
        ...
        if (!discover || !device || !definition || !mapping[definition.model] || device.interviewing ||
