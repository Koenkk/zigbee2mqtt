...
const mapping = {
    ...
    'MCT-340 SMA': [configurations.binary_sensor_contact, configurations.sensor_battery,
        configurations.sensor_temperature,
    ],
    'XHS2-SE': [configurations.binary_sensor_contact, configurations.sensor_battery,
        configurations.sensor_temperature,
    ],
