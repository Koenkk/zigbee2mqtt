...
class HomeAssistant extends Extension {
    ...
    discover(resolvedEntity, force=false) {
        ...
        this.getConfigs(resolvedEntity).forEach((config) => {
            ...
            if (utils.isAvailabilityEnabledForDevice(resolvedEntity, settings.get())) {
                payload.availability_mode = 'all';
            }

            /* istanbul ignore next */
            const availabilityEnabled = utils.isAvailabilityEnabledForDevice(resolvedEntity, settings.get()) ||
