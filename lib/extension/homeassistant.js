...
class HomeAssistant extends BaseExtension {
    ...
    discover(entityID, mappedModel, force=false) {
        ...
        mapping[mappedModel.model].forEach((config) => {
            ...
            if (payload.temperature_command_topic && mappedModel.vendor == 'Eurotronic') {
                payload.temperature_command_topic = `${stateTopic}/set/current_heating_setpoint`;
            }
            else if (payload.temperature_command_topic) {
