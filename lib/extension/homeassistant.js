...
const mapping = {
    ...
    'MCT-340 SMA': [configuration.binary_sensor_contact, configurations.sensor_battery,
        configurations.sensor_temperature,
    ],
    'XHS2-SE': [configuration.binary_sensor_contact, configurations.sensor_battery,
        configurations.sensor_temperature,
    ],
