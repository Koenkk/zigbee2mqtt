...
const cfg = {
    ...
    'binary_sensor_legrand_power_alarm': {
        type: 'binary_sensor',
        object_id: 'legrand_power_alarm',
        discovery_payload: {
            payload_on: true,
            payload_off: false,
            value_template: '{{ value_json.alarm_active}}',
            device_class: 'power',
        },
    },
...
const mapping = {
    ...
    '064888': [cfg.switch],
    '412015': [cfg.sensor_power, cfg.binary_sensor_legrand_power_alarm],
