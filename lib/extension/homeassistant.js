...
const mapping = {
    ...
    'GLSK6ZB-1714': [switchWithPostfix('top_left'),switchWithPostfix('bottom_left'),switchWithPostfix('top_right'),switchWithPostfix('bottom_right')],
    'GLSK6ZB-1715': [switchWithPostfix('top_left'),switchWithPostfix('center_left'),switchWithPostfix('bottom_left'),switchWithPostfix('top_right'),switchWithPostfix('bottom_right')],
    'GLSK6ZB-1716': [switchWithPostfix('top_left'),switchWithPostfix('center_left'),switchWithPostfix('bottom_left'),switchWithPostfix('top_right'),switchWithPostfix('center_right'),switchWithPostfix('bottom_right')],
};
