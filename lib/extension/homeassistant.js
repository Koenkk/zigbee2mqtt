...
const mapping = {
    ...
    'SW2500ZB': [cfg.switch],
    'FGMAXSW001': [switchWithPostfix('ep1'), switchWithPostfix('ep2'), switchWithPostfix('ep3'), switchWithPostfix('ep4'), switchWithPostfix('ep5'), switchWithPostfix('ep6'), switchWithPostfix('ep7'), switchWithPostfix('ep8')],
    'FGMAXPW001': [switchWithPostfix('ep1'), switchWithPostfix('ep2'), switchWithPostfix('ep3'), switchWithPostfix('ep4'), switchWithPostfix('ep5'), switchWithPostfix('ep6'), switchWithPostfix('ep7'), switchWithPostfix('ep8'),
                   lightWithPostfix('ep1'), lightWithPostfix('ep2'), lightWithPostfix('ep3'), lightWithPostfix('ep4'), lightWithPostfix('ep5'), lightWithPostfix('ep6'), lightWithPostfix('ep7'), lightWithPostfix('ep8')],
};
