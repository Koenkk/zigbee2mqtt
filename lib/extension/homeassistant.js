...
const thermostat = (minTemp=7, maxTemp=30, temperatureStateProperty='occupied_heating_setpoint', tempStep=1, 
                    systemModes=['off', 'auto', 'heat'], fanModes=[],  holdModes=[], temperatureLowStateTopic=false, temperatureHighStateTopic=false ) =>
 {
    retVal = {
        type: 'climate',
        object_id: 'climate',
...
const mapping = {
    ...
    '3157100': [thermostat(10, 30, 'occupied_heating_setpoint', 1, ['off', 'heat', 'cool'], ['auto', 'on'], [], true, true, ), cfg.sensor_battery],
    ...
    'RC-2000WH': [thermostat(10, 30, 'occupied_heating_setpoint', 1, ['off', 'auto', 'heat', 'cool'], ['auto', 'on', 'smart'], [], true, true)],
    'TH1300ZB': [thermostat()],
    'SP 220': [cfg.switch],
    ...
    'TS0601_thermostat': [
        ...
        thermostat(5, 30, 'current_heating_setpoint', 0.5, systemModes=[], fanModes=[], holdModes=['schedule', 'manual','away', 'boost', 'complex']),
    ],
