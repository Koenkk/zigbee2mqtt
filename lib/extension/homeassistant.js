...
const genericSensorEndpoint = (endpointName) => {
    return {
        type: 'sensor',
...
const mapping = {
    ...
    'ptvo.switch': [
        ...
        genericSensorEndpoint('l1'), genericSensorEndpoint('l2'), genericSensorEndpoint('l3'),
        genericSensorEndpoint('l4'), genericSensorEndpoint('l5'), genericSensorEndpoint('l6'),
        genericSensorEndpoint('l7'), genericSensorEndpoint('l8'),
