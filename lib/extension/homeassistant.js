...
const manualMaping = {
    ...
    'TS0601_dimmer': [cfg.light_brightness],
    'TS0601_roller_blind': [cfg.light_brightness],
    'JAVISLOCK': [cfg.lock, cfg.sensor_battery, cfg.action_user, cfg.lock_action, cfg.sensor_lock],
};
