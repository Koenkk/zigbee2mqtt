...
const mapping = {
    ...
    'SW2500ZB': [cfg.switch],
    'FGMAXSW001': [
        switchWithPostfix('l1'), switchWithPostfix('l2'), switchWithPostfix('l3'), switchWithPostfix('l4'),
        switchWithPostfix('l5'), switchWithPostfix('l6'), switchWithPostfix('l7'), switchWithPostfix('l8'),
    ],
    'FGMAXPW001': [
        switchWithPostfix('l1'), switchWithPostfix('l2'), switchWithPostfix('l3'), switchWithPostfix('l4'),
        switchWithPostfix('l5'), switchWithPostfix('l6'), switchWithPostfix('l7'), switchWithPostfix('l8'),
