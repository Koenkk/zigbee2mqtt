...
class Availability extends Extension {
    constructor(zigbee, mqtt, state, publishEntityState, eventBus) {
        ...
        this.availability_jitter = settings.get().advanced.availability_jitter;
        this.timers = {};
        this.state = {};
    ...
    setTimerPingable(device) {
        const timeout = this.availability_timeout + timeoutLag(this.availability_timeout, this.availability_jitter);
