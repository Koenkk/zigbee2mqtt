...
class Controller {
    ...
    async start() {
        ...
        for (const device of devices) {
            ...
            const line = mappedDevice ?
                `${mappedDevice.model} - ${mappedDevice.vendor} ${mappedDevice.description}` : 'Not supported';
    ...
    onZigbeeEvent(type, data) {
        ...
        // Call extensions
        this.callExtensionMethod('onZigbeeEvent', [type, data, mappedDevice, settingsDevice]);
    }
