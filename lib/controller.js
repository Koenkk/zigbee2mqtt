...
const ExtensionExternalExtensions = require('./extension/externalExtensions');
...
const AllExtensions = [
    ...
    ExtensionExternalConverters, ExtensionFrontend, ExtensionExternalExtensions,
];
...
class Controller {
    constructor(restartCallback, exitCallback) {
        ...
        this.extensions.push(new ExtensionExternalExtensions(...args, this.addExtension, this.enableDisableExtension));
    }
