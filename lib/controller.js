    ...
    async onZigbeeEvent(type, data) {
        ...
        if (type === 'message') {
            ...
            if (data.status === 'successful') {
                logger.info(`Successfully interviewed '${name}', device has succesfully been paired`);
                ...
                logger.error(`Failed to interview '${name}', device has not succesfully been paired`);
