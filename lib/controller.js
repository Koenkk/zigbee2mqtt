...
// Extensions
const ExtensionPublishToEntity = require('./extension/publishToEntity');
const ExtesionReceiveFromEntity = require('./extension/receiveFromEntity');
...
class Controller {
    constructor() {
        ...
        this.extensions = [
            new ExtensionPublishToEntity(this.zigbee, this.mqtt, this.state, this.publishEntityState),
            new ExtesionReceiveFromEntity(this.zigbee, this.mqtt, this.state, this.publishEntityState),
