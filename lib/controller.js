...
const DeviceAvailabilityHandler = require('./extension/deviceAvailabilityHandler');
...
class Controller {
    constructor() {
        ...
        this.onPublishDeviceState = this.onPublishDeviceState.bind(this);
        ...
        this.extensions = [
            ...
            new DeviceAvailabilityHandler(this.zigbee, this.mqtt, this.state, this.publishDeviceState),
        ];
    ...
    onPublishDeviceState(device, messagePayload) {
        // Call extensions.
        this.extensions
            .filter((e) => e.onPublishDeviceState)
            .forEach((e) => e.onPublishDeviceState(device, messagePayload));
    }
    ...
    publishDeviceState(device, payload, cache) {
        ...
        this.onPublishDeviceState(device, messagePayload);
    }
