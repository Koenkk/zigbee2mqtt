...
const parsers = [
    ...
    {
        devices: ['ZNCZ02LM', 'QBCZ11LM', 'PLUG EDP RE:DY'],
        cid: 'genAnalogInput',
        type: 'attReport',
	...
	},
	{
		...
		type: 'devChange',
		convert: (msg) => {
			console.log("devChange" + msg.data)
		}
	},
    ...
    {
        devices: ['WXKG11LM', 'MCCGQ11LM', 'MCCGQ01LM', 'WXKG01LM', 'LED1545G12', '7146060PH', 'LED1537R6', 'ZNCZ02LM', 'QBCZ11LM', 'QBKG04LM', 'QBKG03LM', 'LED1623G12', 'LED1650R5', 'LED1536G5', 'PLUG EDP RE:DY'],
        cid: 'genOnOff',
        type: 'devChange',
        convert: () => null
    },
