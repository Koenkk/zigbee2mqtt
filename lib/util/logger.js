...
if (output.includes('file')) {
    fs.unlink(current, function(err, result) { if(err) console.log('error', err); });
    fx.mkdirSync(directory);
    fs.symlink(actual, current, function(err, result) { if(err) console.log('error', err); else console.log('result', result); });
}
