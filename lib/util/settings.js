...
const defaults = {
    ...
    ota:{
         ...
         */
        update_check_interval: 600000,
        /**
         * Completely disallow Zigbee devices to initiate a search for a potential firmware update. If set to true, only a user-initiated update search will be possible.
         */
