...
const defaults = {
    ...
    advanced: {
        ...
        /**
         * Configurable support for subscribing to the whole prefix rather than specific topics
         */
        subscribe_to_whole_prefix: false,
    },
    external_converters: [],
};
    ...
    properties: {
        ...
        advanced: {
            ...
            properties: {
                ...
                subscribe_to_whole_prefix: {type: 'boolean'},
            },
        },
        map_options: {
            type: 'object',
