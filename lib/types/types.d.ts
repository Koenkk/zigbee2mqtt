...
import type * as ZHCTypes from 'zigbee-herdsman-converters/lib/types';
...
declare global {
    ...
    namespace zhc {
        type Definition = ZHCTypes.Definition;
        type ToZigbeeConverter = ZHCTypes.Tz.Converter;
        type DefinitionExpose = ZHCTypes.Expose;
