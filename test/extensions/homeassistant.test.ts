...
describe("Extension: HomeAssistant", () => {
    ...
    it("Should discover devices with fan", () => {
        const payload = {
            ...
            percentage_value_template:
                "{% if \"fan_mode\" in value_json %}{{ {'off':0, 'low':1, 'medium':2, 'high':3, 'on':4}[value_json[\"fan_mode\"]] | default('None') }}{% endif %}",
            ...
            preset_mode_value_template:
                '{% if "fan_mode" in value_json %}{{ value_json["fan_mode"] if value_json["fan_mode"] in [\'smart\'] else \'None\' }}{% endif %}',
            preset_modes: ["smart"],
            speed_range_min: 1,
            speed_range_max: 4,
            name: null,
    ...
    it("Should discover devices with speed-controlled fan", () => {
        const payload = {
            ...
            percentage_value_template: '{% if "speed" in value_json %}{{ value_json["speed"] }}{% endif %}',
