...
const {coordinator, bulb, unsupported, WXKG11LM, remote, ZNCZ02LM, bulb_color_2, WSDCGQ11LM, zigfred_plus, BMCT_SLZ} = zigbeeHerdsman.devices;
...
zigbeeHerdsman.returnDevices.push(BMCT_SLZ.ieeeAddr);
...
describe('Bridge', () => {
    ...
    it('Should publish event and devices when device interview successful', async () => {
        ...
        await flushPromises();
        expect(MQTT.publish).toHaveBeenCalledTimes(9);
