...
Other ways to run Zigbee2mqtt are [Docker](../useful_information/docker.md) and the [Hass.io Zigbee2mqtt add-on](https://github.com/danielwelch/hassio-zigbee2mqtt).
